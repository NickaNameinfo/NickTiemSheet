    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/Dashboard" element={<Dashboard />}>
          ...
          <Route path="/Dashboard/Inandout" element={<Attendance />}></Route>
          ...
          ></Route>
          <Route
            path="/Dashboard/Reports/ConsolidatedReport"
            element={<ConsolidatedReport />}
          ></Route>
          <Route
            path="/Dashboard/Reports/EmployeeReport"
            element={<EmployeeReport />}
          ></Route>
          <Route
            path="/Dashboard/Reports/WeeklyReport"
            element={<WeeklyReport />}
          ></Route>
          <Route
            path="/Dashboard/Reports/MonthlyReport"
            element={<MonthlyReport />}
          ></Route>
          <Route
            path="/Dashboard/Reports/YearlyReport"
            element={<YearlyReport />}
          ></Route>
          <Route
            path="/Dashboard/Reports/CodeReport"
            element={<DesciplineCodeReport />}
          ></Route>
          <Route
            path="/Dashboard/Reports/LeaveReport"
            element={<LeaveReport />}
          ></Route>
          {/* <Route path="/Dashboard/employeeEdit/:id" element={<EditEmployee />}></Route> */}
          <Route
            path="/Dashboard/EmployeeHome"
            element={<EmployeeHome />}
          ></Route>
          <Route
            path="/Dashboard/AddProjectDetails"
            element={<AddProjectDetails />}
          ></Route>
          <Route
            path="/Dashboard/AddLeaves"
            element={<AddLeaveDetails />}
          ></Route>
          <Route path="/Dashboard/CompOff" element={<CompOff />}></Route>
          <Route
            path="/Dashboard/TimeManagement"
            element={<TimeManagement />}
          ></Route>
          <Route
            path="/Dashboard/TeamLeadHome"
            element={<TeamLeadHome />}
          ></Route>
