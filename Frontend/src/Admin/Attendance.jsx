...
function Attendance() {
  ...
  useEffect(() => {
    ...
    console.log(selectedYear, "currentYear345234");
  ...
  const getInOutTime = async (dates, userId) => {
    try {
      // Fetch user details
      ...
      console.log("ueruiteste", Number(userId?.replace(/[A-Za-z]/g, "")));
      // Prepare data for filtering
      const data = {
        userId: userId
          ? Number(userId?.replace(/[A-Za-z]/g, ""))
          : Number(userDetails?.employeeId?.replace(/[A-Za-z]/g, "")),
